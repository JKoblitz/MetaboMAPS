    ...
    (function ($, window, document, undefined) {
        ...
        AmsifySuggestags.prototype = {
            ...
            addTag: function (item, cl = "", manual = true, putative = false) {
                ...
                var html = '<span class="' + this.classes.tagItem.substring(1) + ' ' + cl + '" data-val="' + value + '">' + this.getTag(tag) + ' ' + this.setIcon() + '</span>';
            ...
            setIcon: function () {
                ...
                if (this.settings.type == 'bootstrap') {
                    return '<span class="' + removeClass + '">&times;</span>';
